...
//    private static final long PRELOAD_PERIOD = TimeUnit.HOURS.toMillis(24);
    private static final long PRELOAD_PERIOD = TimeUnit.DAYS.toMillis(3);
...
//            config.loadAndEncrypted(CONFIG);
            ...
            m_ticksTs = collectTicks
                    ...
                    : new NoTicksTimesSeriesData<TickData>(null); // : new TicksTimesSeriesDataToDelete(collectTicks);
