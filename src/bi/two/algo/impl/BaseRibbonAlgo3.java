...
abstract class BaseRibbonAlgo3 extends BaseRibbonAlgo2 {
    ...
    protected abstract void recalc4();
    ...
    @Override protected final void recalc3() {
        // m_tailStart can be changed inside of m_ribbon.update()
        m_ribbon.update(m_directionChanged, m_mid, m_head, m_tail, m_goUp); // use local var to speedup
