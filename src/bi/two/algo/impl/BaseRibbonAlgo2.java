...
abstract class BaseRibbonAlgo2 extends BaseRibbonAlgo1 {
    ...
    protected abstract void recalc3(float lastPrice, float emasMin, float emasMax, float leadEmaValue,
                                    float maxRibbonSpread, float ribbonSpreadTop, float ribbonSpreadBottom, float mid, float head, float tail);

    protected final void recalc2(float lastPrice, float emasMin, float emasMax, float leadEmaValue,
        ...
        recalc3(lastPrice, emasMin, emasMax, leadEmaValue, maxRibbonSpread, ribbonSpreadTop,
